...
var _default = {
  ...
  methods: {
    ...
    generateZip: function generateZip() {
      ...
      var split_loc = current_loc.split("/").pop(); //call the custom route
      //and download the file that it sends back

      var formData = new FormData(); //append the url location
      ...
      var href = location.href.split("panel");
      var _url = href[0];
      fetch("".concat(_url, "generate-zip"), {
        method: "POST",
        body: formData
      }).then(function (res) {
        return res.blob();
...
exports.default = _default;
        var $10f0c4 = exports.default || module.exports;
      
      if (typeof $10f0c4 === 'function') {
        $10f0c4 = $10f0c4.options;
      }
    
        /* template */
        Object.assign($10f0c4, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "container" }, [
    _c("form", [
      _c("p", [_vm._v("Fill the fields to edit the default values")]),
      _vm._v(" "),
      _c("div", { staticClass: "form-field" }, [
        ...
        _c("input", {
          ...
          attrs: {
            placeholder: "Shell Course Title",
            type: "text",
            name: "title"
          },
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-field" }, [
        _c("label", { attrs: { for: "id" } }, [_vm._v("Course ID")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
          ...
          attrs: {
            type: "text",
            placeholder: "org.shell.course.title",
            name: "id"
          },
      ...
      _c("div", { staticClass: "form-field" }, [
        ...
        _c("input", {
          ...
          attrs: {
            name: "organization",
            placeholder: "shell_organization",
            type: "text"
          },
      ...
      _c("div", { staticClass: "form-field" }, [
        ...
        _c("input", {
          ...
          attrs: { name: "score", placeholder: "70", type: "number" },
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-field-submit" }, [
        _c(
          "button",
          {
            staticClass: "button",
            ...
            on: {
              click: function($event) {
                ...
                return _vm.generateZip.apply(null, arguments)
              }
            }
          },
          [_vm._v("Generate Package")]
        )
      ])
    ])
  ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$10f0c4', $10f0c4);
          } else {
            api.reload('$10f0c4', $10f0c4);
          }
        }
